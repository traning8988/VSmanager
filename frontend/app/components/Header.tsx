          ...
          teamId !== 1 ? (
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                <DropdownMenuItem><Link href={'/teams'} className="w-full">チーム情報</Link></DropdownMenuItem>
                <DropdownMenuItem><Link href={'/games/match-requests'} className="w-full">試合申し込み</Link></DropdownMenuItem>
